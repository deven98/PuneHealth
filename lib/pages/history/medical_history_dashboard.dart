    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          _buildMedicalHistoryCard(hospitalName: "Sahyadri Hospital", appointmentDate: "19/02/18", medicalNote: "Mild Fever and Cold"),
          _buildMedicalHistoryCard(hospitalName: "Chintamani Hospital", appointmentDate: "19/02/18", medicalNote: "Dengue Fever detected. Low platelet count. Medicines include: ABC, XYZ"),
          _buildMedicalHistoryCard(hospitalName: "Sahyadri", appointmentDate: "19/02/18", medicalNote: "Mild Fever and Cold"),
        ],
      ),
    );
  }
